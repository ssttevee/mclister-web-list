	...
	<form method="post" id="new-server-form">
		...
		<div class="col-lg-8" style="display:none;" id="step-3">
			...
			<dd data-toggle="buttons">
				...
				<div class="hidden" id="verify-owner-challenge"><?php echo $verify_owner_key; ?></div>
			</dd><br/>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<pre><?php echo $verify_owner_hash; ?></pre>
...
window.addEventListener("load", function(e) {
	...
	$('#verify-owner-action').click(function() {
		var btn = $(this);
		btn.button('loading')
		$.post("<?php echo $ALIASES['verify_owner']; ?>", {
				...
				if( json.response === "true" ) {
					alert("Success!");
					$('#new-server-form').attr('action', '<?php echo $ALIASES['add_server']; ?>');
