<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="stevieiswonderful-facilitator_api1.gmail.com";
	$API_Password="1396145412";
	$API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31ALHFJT7uFMXV4-Fux48GbIQ1jIZn";
	...
	*/
	function hash_call($methodName,$nvpStr)
	{
		...
		$response = file_get_contents('https://api-3t.sandbox.paypal.com/nvp', false, $context);
